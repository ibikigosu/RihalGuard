...
DEFAULT_INPUT = os.environ.get(
    "RIHALGUARD_INPUT",
    "Transcript: Aisha: We agreed to keep the pilot limited to finance operations. "
    "Khalid: I will draft the review checklist by Thursday. "
    "Maya: The ERP posting step needs legal review before anyone automates it.",
)
