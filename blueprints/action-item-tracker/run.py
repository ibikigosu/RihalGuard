...
DEFAULT_INPUT = os.environ.get(
    "RIHALGUARD_INPUT",
    "Meeting notes: Sara will send the revised vendor list by Friday. "
    "Omar said the budget decision is still pending. "
    "The team discussed maybe creating a ticket later, but no owner was assigned.",
)
